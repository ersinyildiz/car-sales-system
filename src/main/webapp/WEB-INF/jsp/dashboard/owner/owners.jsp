...
<div class="wrapper">
    ...
    <div id="content">
        ...
        <div class="container">
            <hr class="hr-text" data-content="İlan Sahipleri">
            <c:if test="${successfullyAddedOwner ne null}">
                <div class="alert alert-primary" role="alert">
                    <i class="fas fa-check-circle mr-2"></i> ${successfullyAddedOwner}
                </div>
            </c:if>
            <c:if test="${foundedOwner ne null}">
                <div class="alert alert-primary" role="alert">
                    <i class="fas fa-check-circle mr-2"></i> ${foundedOwner}
                </div>
            </c:if>
            <c:if test="${ownerList.size() eq 0}">
                <div class="alert alert-danger" role="alert">
                    <i class="fa fa-exclamation-triangle mr-2"></i>
                    Sistemde kayıtlı ilan sahibi bulunmamaktadır.
                </div>
            </c:if>
